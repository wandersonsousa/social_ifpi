                            ...
                            <div className="md:flex md:h-full md:items-center">
                                <div className="w-full my-6 py-6 px-6 text-white bg-gray-750 rounded-lg md:max-w-sm md:min-w-20">
                                    <div className="flex justify-between md:flex-col md:items-center">
                                        ...
                                        <Image alt="broken image" src={UserProfile.profileimage} layout="fill" onLoad={() => setimageLoaded(true)} />
                                        </div>
                                    ...
                                    {user.displayName == router.query.username ? <Link href={`/${user.displayName}?edit=true`}><a><div className="text-center"><p className="py-2 mt-6 font-semibold bg-purple-550 rounded-lg">Configurações</p></div></a></Link> : null}
