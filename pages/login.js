            ...
            {user ? gotohome() : 
                ...
                <div className="w-screen h-screen px-12 flex justify-center items-center">
                    <div className="w-full h-2/6 flex flex-col justify-evenly text-white md:max-w-sm">
                        <Link href="/"><a className="w-10"><div className="h-10 w-10 relative"><Image alt="broken image" src="/logo.png" layout="fill" /></div></a></Link>
                        <h1 className="font-bold text-4xl mt-5">Faça Login para continuar</h1>
                        ...
                        <Link href="/login?signup=true" as="/signup"><a className="font-semibold underline text-center outline-none focus:text-purple-550"><p>Não possuo uma conta</p></a></Link>
                    </div>
                </div>
