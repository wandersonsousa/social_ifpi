        ...
        <div className="h-screen w-screen bg-gray-850 overflow-y-scroll p-8 text-white rounded-lg md:max-w-md md:h-auto md:max-h-screen">
            ...
            <div className="flex justify-between items-center">
                <div className="flex items-center">
                    ...
                    <p className="font-bold text-2xl pl-2">Criar Post</p>
                </div>
                ...
                <form>
                    <div className="mb-5">
                        <div className="mb-5 flex justify-center items-center">
                            {/* image preview */}
                            {ImagePreview ? <>
                                <div className="rounded-lg h-44 overflow-hidden w-full relative"><Image alt="broken image" src={ImagePreview} layout="fill" objectFit="contain"/></div>
                            </> : null}
                        </div>
                    ...
                    <div>
                        {uploadError ? <p className="text-red-700 text-center font-semibold">Imagem e legenda são requeridas.</p> : null}
                    </div>
                    <div>
